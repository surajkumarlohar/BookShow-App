    ...
    <div>
      {show && (
        <div className="px-4 py-5 my-5 text-center">
          <img className="d-block mx-auto mb-4" src={show.image ? show.image.medium : "blank"} alt="" width="400" height="400"/>
          <h1 className="display-5 fw-bold text-body-emphasis">{show.name}</h1>
          <div className="col-lg-6 mx-auto">
            <p className="lead mb-4" dangerouslySetInnerHTML={{ __html: show.summary }} ></p>
            ...
            <a href={show.url} target="_blank">Official Site</a>
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="text" name="MovieName" onChange={onChange} value={details.MovieName}/>
                  </div>
                  <div className="mb-3">
                  ...
                  <div className="mb-3">
                    ...
                    <input type="number" className="form-control" id="mobile"  name="Mobile" placeholder="Enter your Mobile no" onChange={onChange}/>
                  </div>
                  <div className="mb-3">
                    <label htmlFor="comment" className="form-label">
                      Comment:
                    </label>
                    <textarea className="form-control" id="comment" rows="3" name="Comment" onChange={onChange}></textarea>
                  </div>
                </div>
                <div className="modal-footer">
                  ...
                  <button type="button" onClick={handleClicking} className="btn  btn-primary">
                    Confirm Booking
                  </button>
                </div>
              </div>
